    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="合伙人返佣比例" prop="agentRebateAmount">
          <el-input v-model="form.agentRebateAmount" placeholder="请输入合伙人返佣比例" />
        </el-form-item>
        <el-form-item label="直接推荐人返佣比例" prop="directRecommenderAmount">
          <el-input v-model="form.directRecommenderAmount" placeholder="请输入直接推荐人返佣比例" />
        </el-form-item>
        <el-form-item label="间接推荐人返佣比例" prop="indirectRecommenderAmount">
          <el-input v-model="form.indirectRecommenderAmount" placeholder="请输入间接推荐人返佣比例" />
        </el-form-item>
