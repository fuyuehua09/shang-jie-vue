<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="exchangeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="积分兑换id" align="center" prop="id" v-if="false"/>
      <el-table-column label="用户id" align="center" prop="userId" />
      <el-table-column label="订单号" align="center" prop="orderNo" />
      <el-table-column label="金额" align="center" prop="amount" />
      <el-table-column label="状态" align="center" prop="state" />
      <el-table-column label="商品名称" align="center" prop="serviceName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="商品名称" prop="serviceName">
          <el-input v-model="form.serviceName" placeholder="请输入商品名称" />
        </el-form-item>
...
<script>
import { listExchange, getExchange, delExchange, addExchange, updateExchange, exportExchange } from "@/api/system/exchange";
