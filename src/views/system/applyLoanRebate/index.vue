<template>
  <div class="app-container">
    ...
    >
      ...
      <!-- <el-table-column label="用户积分" align="center" prop="loanIntegral">
        <template slot-scope="scope">
          <p>{{ scope.row.loanIntegral }}</p>
        </template>
      </el-table-column> -->
      <el-table-column label="合伙人" align="center" prop="agentRebate">
        <template slot-scope="scope">
          <p>{{ scope.row.agentRebate }}%</p>
        </template>
      </el-table-column>
      <el-table-column
        label="间接推荐人"
        align="center"
        prop="indirectRecommenderRebate"
      >
        <template slot-scope="scope">
          <p>{{ scope.row.indirectRecommenderRebate }}%</p>
        </template>
      </el-table-column>
      <el-table-column
        label="直接推荐人"
        align="center"
        prop="directRecommenderRebate"
      >
        <template slot-scope="scope">
          <p>{{ scope.row.directRecommenderRebate }}%</p>
        </template>
      </el-table-column>
      <!-- <el-table-column label="分享图" align="center" prop="maximumAmount">
        <template slot-scope="scope">
          <el-link type="success" :href="scope.row.sharePhoto" target="_blank"
            >分享图</el-link
          >
        </template>
      </el-table-column> -->
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="160px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="合伙人" prop="agentRebate">
              <el-input
                v-model="form.agentRebate"
                placeholder="请输入合伙人返佣比例"
                ><i slot="suffix">%</i></el-input
              >
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="间接推荐人" prop="indirectRecommenderRebate">
              <el-input
                v-model="form.indirectRecommenderRebate"
                placeholder="请输入间接推荐人返佣比例"
                ><i slot="suffix">%</i></el-input
              >
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="直接推荐人" prop="directRecommenderRebate">
              <el-input
                v-model="form.directRecommenderRebate"
                placeholder="请输入直接推荐人返佣比例"
                ><i slot="suffix">%</i></el-input
              >
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <!-- <el-form-item label="用户积分" prop="loanIntegral">
              <el-input v-model="form.loanIntegral" placeholder="用户积分" />
            </el-form-item> -->
          </el-col>
        </el-row>
        <!-- <el-row>
        ...
        <!-- <el-form-item label="申请人返佣金额" prop="applicantRebate">
          <el-input v-model="form.applicantRebate" placeholder="请输入申请人返佣金额" />
        </el-form-item> -->
        <el-form-item label="申请条件">
          <vue-ueditor-wrap v-model="form.conditions"/>
          <!-- <editor-bar v-model="form.conditions"></editor-bar> -->
          <!-- <editor v-model="form.conditions" :min-height="192" /> -->
        </el-form-item>
...
<script>
import { listList, getList, delList, addList, updateList, exportList, changeType, changeVisible } from "@/api/system/bankList";
